...
tar -xvzf oam-0.1.2.iosmcn.smo.oam.tar.gz
cd oam-0.1.2.iosmcn.smo.oam
```
...
Step 2 : untar the focom-0.1.2.iosmcn.smo.focom.tar.gz

```sh
cd iosmcn.agartala.v0.2.0.smo.source
tar -xvzf focom-0.1.2.iosmcn.smo.focom.tar.gz
cd focom-0.1.2.iosmcn.smo.focom
```
...
Step 2 : untar the nfo-0.1.2.iosmcn.smo.nfo.tar.gz

```sh
cd iosmcn.agartala.v0.2.0.smo.source
tar -xvzf nfo-0.1.2.iosmcn.smo.focom.tar.gz
cd focom-0.1.2.iosmcn.smo.nfo
```
